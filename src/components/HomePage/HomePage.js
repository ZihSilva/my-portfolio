...
export function HomePage() {
  return (
    <div
      ...
      className="bg-indigo-300 dark:bg-slate-900 dark:text-white  w-full flex-col flex items-center font-myfont xs:pl-8"
    >
      <div className="w-2/3 mx-auto h-full flex flex-col justify-center items-center sm:flex-row">
        <div className="sm:flex gap-2 items-center">
          <div className=" w-40  h-40 mt-14 mb-10  md:w-70 lg:w-60 sm:mr-4">
            <img
              src={profilePhoto}
              alt="profile"
          ...
          <div className="mt-8 pl-4 sm:pl-6 md:pl-4">
            <p className="text-white text-xl sm:text-xl mb-1">My Name is</p>
            <h1 className="text-white  text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-1 font-bold">
              Zimarlen Silva
            </h1>
